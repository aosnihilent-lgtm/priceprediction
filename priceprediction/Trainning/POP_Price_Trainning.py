...
def train_pop_models():

    print("🚀 Starting POP Training Pipeline...")
    ...
    # Save artifact
    # -----------------------------
    joblib.dump(pipeline, "artifacts/pop_price_model.joblib")

    print("Model training complete.")
    return "POP Model training complete."